...
class IllegalUpdateError extends CustomError {
        constructor(message) {
        // Passes the message to CustomError
        super(message);
        // Sets the name of the error
        this.name = 'IllegalUpdateError';
        // Sets the statusCode for this instance of IllegalUpdateError
...
module.exports = IllegalUpdateError;