...
describe('productResponseSchema - HAPPY PATH TEST - product_name', () => {
    test('should accept a valid product_name of minimum length (3 characters)', () => {
        ...
        const testData = {
            ...
            if (result?.error?.issues !== undefined){
                console.log("productResponseSchema - should accept a valid product_name of minimum length (3 characters) - product_name - result?.error?.issues ", result?.error?.issues);
            }
            
            else {
                console.log("productResponseSchema - should accept a valid product_name of minimum length (3 characters) - product_name - result ", result);
            }
            ...
            test('should accept a valid product_name of maximum length (50 characters)', () => {
        ...
        const testData = {
            ...
            [
                {
                    ...
                    image_uri: "C:\\Users\\saswa\\OneDrive\\Desktop\\Taylor_Stitch\\Website\\ActualData\\Long-Sleeved_Shirts\\The_Craftsman_Shirt\\The_Craftsman_Shirt_in_Bark_Plaid_Linen\\instock_m_q225_craftsman_bark_portrait_001.jpg",
            ...
            if (result?.error?.issues !== undefined){
                console.log("productResponseSchema - should accept a valid product_name of maximum length (50 characters) - product_name - result?.error?.issues ", result?.error?.issues);
            }
            
            else {
                console.log("productResponseSchema - should accept a valid product_name of maximum length (50 characters) - product_name - result ", result);
            }
