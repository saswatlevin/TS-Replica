...
describe('userResponseGenericSchema - password Field Tests', () => {
    test('userResponseGenericSchema - should accept valid password hash with correct format', () => {
        // Arrange
        const testData = {
    ...
    test('userResponseGenericSchema - should reject password hash with insufficient length (below 97 characters)', () => {
        // Arrange
        const testData = {
            user_id: "ab01dhiojniu",
            docType: "USER",
    ...
    test('userResponseGenericSchema - should reject password hash with excessive length (above 97 characters)', () => {
        // Arrange
        const testData = {
            user_id: "ab01dhiojniu",
            docType: "USER",
    ...
    test('userResponseGenericSchema - should reject missing password hash (null value)', () => {
        // Arrange
        const testData = {
            user_id: "ab01dhiojniu",
            docType: "USER",
