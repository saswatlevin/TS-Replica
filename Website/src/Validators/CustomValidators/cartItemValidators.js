...
const zodIsItemTotal = z.number("The item_total field must be a number. It is a required field.").int("The item_total field must be an integer.").min(1, {message: "The minimum limit of the item_total field is 1."}).max(10000, {message: "The maximum limit of the item_total field is 10000"});
