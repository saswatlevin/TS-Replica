...
describe('searchProductSchema - HAPPY PATH TEST - product_category', () => {
    test('should accept a valid product_category - TEST 1', () => {
        ...
        if (result?.error?.issues !== undefined){
            console.log("searchProductSchema - should accept a valid product_category - TEST 1 - result?.error?.issues ", result?.error?.issues);
        }   

        else{
            console.log("searchProductSchema - should accept a valid product_category - TEST 1 - result ", result);
        }
        ...
        const result = searchProductSchema.safeParse(testData);
        if (result?.error?.issues !== undefined){
            console.log("searchProductSchema - should accept a valid product_category - TEST 2 - result?.error?.issues ", result?.error?.issues);
        }   

        else{
            console.log("searchProductSchema - should accept a valid product_category - TEST 2 - result ", result);
        }
