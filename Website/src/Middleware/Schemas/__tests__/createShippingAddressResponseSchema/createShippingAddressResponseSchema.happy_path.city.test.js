...
describe('createShippingAddressResponseSchema - CITY Boundary Tests', () => {
    test('createShippingAddressResponseSchema - should accept city minimum length "Rio"', () => {
        // Arrange
        const testData = {
        ...
        if (result?.error?.issues !== undefined){
            console.log("createShippingAddressResponseSchema - should accept city minimum length Rio - result?.error?.issues ", result?.error?.issues);
        }
        else {
            console.log("createShippingAddressResponseSchema - should accept city minimum length Rio - result ", result);
        }
    ...
    test('createShippingAddressResponseSchema - should accept city maximum length', () => {
        // Arrange
        ...
        if (result?.error?.issues !== undefined){
            console.log("createShippingAddressResponseSchema - should accept city maximum length - result?.error?.issues ", result?.error?.issues);
        }
        else {
            console.log("createShippingAddressResponseSchema - should accept city maximum length - result ", result);
        }
