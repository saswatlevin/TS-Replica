...
describe('productRequestSchema - HAPPY PATH TEST - product_color', () => {
    test('should accept a valid product_color of minimum length (1 characters)', () => {
        ...
        const testData = {
            ...
            if (result?.error?.issues !== undefined){
                console.log("productRequestSchema - should accept a valid product_color of minimum length (1 character) - product_color - result?.error?.issues ", result?.error?.issues);
            }
            
            else {
                console.log("productRequestSchema - should accept a valid product_color of minimum length (1 character) - product_color - result ", result);
            }
        ...
        const testData = {
            ...
            if (result?.error?.issues !== undefined){
                console.log("productRequestSchema - should accept a valid product_color of maximum length (50 characters) - product_color - result?.error?.issues ", result?.error?.issues);
            }
            
            else {
                console.log("productRequestSchema - should accept a valid product_color of maximum length (50 characters) - product_color - result ", result);
            }
