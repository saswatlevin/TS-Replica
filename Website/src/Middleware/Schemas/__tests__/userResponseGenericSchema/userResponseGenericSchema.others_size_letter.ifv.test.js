...
const { userResponseGenericSchema } = require('../../userSchemas');
    ...
    describe('userResponseGenericSchema - Others Size Letter Field Validation Tests', () => {
        test('userResponseGenericSchema - should accept valid others_size_letter (XXL)', () => {
            // Arrange
            const testData = {
        ...
        test('userResponseGenericSchema - should accept valid others_size_letter (XL)', () => {
            // Arrange
            const testData = {
                user_id: "ab01dhiojniu",
                docType: "USER",
        ...
        test('userResponseGenericSchema - should accept valid others_size_letter (L)', () => {
            // Arrange
            const testData = {
                user_id: "ab01dhiojniu",
                docType: "USER",
        ...
        test('userResponseGenericSchema - should accept valid others_size_letter (M)', () => {
            // Arrange
            const testData = {
                user_id: "ab01dhiojniu",
                docType: "USER",
        ...
        test('userResponseGenericSchema - should accept valid others_size_letter (S)', () => {
            // Arrange
            const testData = {
                user_id: "ab01dhiojniu",
                docType: "USER",
        ...
        test('userResponseGenericSchema - should accept valid others_size_letter (XS)', () => {
            // Arrange
            const testData = {
                user_id: "ab01dhiojniu",
                docType: "USER",
        ...
        test('userResponseGenericSchema - should reject invalid others_size_letter (XXXL - not in enum)', () => {
            // Arrange
            const testData = {
                user_id: "ab01dhiojniu",
                docType: "USER",
        ...
        test('userResponseGenericSchema - should reject invalid others_size_letter (XXS - not in enum)', () => {
            // Arrange
            const testData = {
                user_id: "ab01dhiojniu",
                docType: "USER",
        ...
        test('userResponseGenericSchema - should reject invalid others_size_letter datatype (number)', () => {
            // Arrange
            const testData = {
                user_id: "ab01dhiojniu",
                docType: "USER",
        ...
        test('userResponseGenericSchema - should reject empty others_size_letter', () => {
            // Arrange
            const testData = {
                user_id: "ab01dhiojniu",
                docType: "USER",
        ...
        test('userResponseGenericSchema - should reject missing others_size_letter (null)', () => {
            // Arrange
            const testData = {
                user_id: "ab01dhiojniu",
                docType: "USER",
