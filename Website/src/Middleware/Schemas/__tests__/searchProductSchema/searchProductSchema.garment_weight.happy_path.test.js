...
describe('searchProductSchema - HAPPY PATH TEST - garment_weight', () => { 
    test('should accept valid garment_weight - TEST 1', () => {
        ...
        if (result?.error?.issues !== undefined){
            console.log("searchProductSchema - should accept valid garment_weight - TEST 1 - garment_weight - result?.error?.issues ", result?.error?.issues);
        }
            
        else {
            console.log("searchProductSchema - should accept valid garment_weight - TEST 1 - garment_weight - result ", result);
        }
        ...
        if (result?.error?.issues !== undefined){
            console.log("searchProductSchema - should accept valid garment_weight - TEST 2 - garment_weight - result?.error?.issues ", result?.error?.issues);
        }
            
        else {
            console.log("searchProductSchema - should accept valid garment_weight - TEST 2 - garment_weight - result ", result);
        }
