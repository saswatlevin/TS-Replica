...
describe('userShippingAddressResponseSchema - Happy Path Tests', () => {
    
    describe('Basic Happy Path Test Cases', () => {
        test('should accept complete valid user data with admin role', () => {
            // Arrange
            const validUserData = {
            ...
            console.log("userShippingAddressResponseSchema - should accept complete valid user data with admin role - result?.error?.issues ", result?.error?.issues);

            // Assert
            expect(result.success).toBe(true);
            //expect(result.data._id).toEqual(new mongoose.Types.ObjectId("656f7c9a8b3e4f1d2a7b9c0e"));
        ...
        test('should accept complete valid user data with user role', () => {
            // Arrange
            const validUserData = {
                _id: new mongoose.Types.ObjectId("656f7c9a8b3e4f1d2a7b9c0e"),
            ...
            // Act
            const result = userShippingAddressResponseSchema.safeParse(validUserData);
            console.log("userShippingAddressResponseSchema - should accept complete valid user data with user role - result?.error?.issues ", result?.error?.issues);
    ...
    describe('Happy Path Boundary Test Cases', () => {
        test('should accept valid date boundary value (59:59 seconds)', () => {
            ...
            // Act
            const result = userShippingAddressResponseSchema.safeParse(validUserData);
            console.log("userShippingAddressResponseSchema - should accept valid date boundary value (59:59 seconds) - result?.error?.issues ", result?.error?.issues);
        ...
        test('should accept valid email with special characters', () => {
            ...
            // Act
            const result = userShippingAddressResponseSchema.safeParse(validUserData);
            console.log("userShippingAddressResponseSchema - should accept valid email with special characters - result?.error?.issues ", result?.error?.issues);
        ...
        test('should accept email at minimum length boundary (9 characters)', () => {
            ...
            // Act
            const result = userShippingAddressResponseSchema.safeParse(validUserData);
            console.log("userShippingAddressResponseSchema - should accept email at minimum length boundary (9 characters) - result?.error?.issues ", result?.error?.issues);
        ...
        test('should accept email at maximum length boundary (30 characters)', () => {
            ...
            // Act
            const result = userShippingAddressResponseSchema.safeParse(validUserData);
            console.log("userShippingAddressResponseSchema - should accept email at maximum length boundary (30 characters) - result?.error?.issues ", result?.error?.issues);
        ...
        test('should accept phone number at minimum length boundary (8 digits)', () => {
            ...
            // Act
            const result = userShippingAddressResponseSchema.safeParse(validUserData);
            console.log("userShippingAddressResponseSchema - should accept phone number at minimum length boundary (8 digits) - result?.error?.issues ", result?.error?.issues);
        ...
        test('should accept phone number at maximum length boundary (12 digits)', () => {
            ...
            // Act
            const result = userShippingAddressResponseSchema.safeParse(validUserData);
            console.log("userShippingAddressResponseSchema - should accept phone number at maximum length boundary (12 digits) - result?.error?.issues ", result?.error?.issues);
        ...
        test('should accept first name with special characters (apostrophe)', () => {
            ...
            // Act
            const result = userShippingAddressResponseSchema.safeParse(validUserData);
            console.log("userShippingAddressResponseSchema - should accept first name with special characters (apostrophe) - result?.error?.issues ", result?.error?.issues);
        ...
        test('should accept first name at minimum length boundary (1 character)', () => {
            ...
            // Act
            const result = userShippingAddressResponseSchema.safeParse(validUserData);
            console.log("userShippingAddressResponseSchema - should accept first name at minimum length boundary (1 character) - result?.error?.issues ", result?.error?.issues);
        ...
        test('should accept first name at maximum length boundary (100 characters)', () => {
            ...
            // Act
            const result = userShippingAddressResponseSchema.safeParse(validUserData);
            console.log("userShippingAddressResponseSchema - should accept first name at maximum length boundary (100 characters) - result?.error?.issues ", result?.error?.issues);
        ...
        test('should accept last name with special characters (hyphen)', () => {
            ...
            // Act
            const result = userShippingAddressResponseSchema.safeParse(validUserData);
            console.log("userShippingAddressResponseSchema - should accept last name with special characters (hyphen) - result?.error?.issues ", result?.error?.issues);
        ...
        test('should accept last name at minimum length boundary (1 character)', () => {
            ...
            // Act
            const result = userShippingAddressResponseSchema.safeParse(validUserData);
            console.log("userShippingAddressResponseSchema - should accept last name at minimum length boundary (1 character) - result?.error?.issues ", result?.error?.issues);
        ...
        test('should accept last name at maximum length boundary (100 characters)', () => {
            ...
            // Act
            const result = userShippingAddressResponseSchema.safeParse(validUserData);
            console.log("userShippingAddressResponseSchema - should accept last name at maximum length boundary (100 characters) - result?.error?.issues ", result?.error?.issues);
