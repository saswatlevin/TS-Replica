...
describe('productResponseSchema - HAPPY PATH TEST - product_id', () => {
    test('should accept a valid product_id - TEST 1', () => {
        ...
        if (result?.error?.issues !== undefined){
            console.log("productResponseSchema - should accept a valid product_id - TEST 1 - product_id - result?.error?.issues ", result?.error?.issues);
        }
        
        else {
            console.log("productResponseSchema - should accept a valid product_id - TEST 1 - product_id - result ", result);
        }
    ...
    test('should accept a valid product_id - TEST 2', () => {
        ...
        const testData = {
            ...
            if (result?.error?.issues !== undefined){
                console.log("productResponseSchema - should accept a valid product_id - TEST 2 - product_id - result?.error?.issues ", result?.error?.issues);
            }
            
            else {
                console.log("productResponseSchema - should accept a valid product_id - TEST 2 - product_id - result ", result);
            }
