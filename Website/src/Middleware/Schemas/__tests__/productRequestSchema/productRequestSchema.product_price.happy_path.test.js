...
describe('productRequestSchema - HAPPY PATH TEST - product_price', () => {
    test('should accept a valid product_price of minimum value (1)', () => {
        ...
        const testData = {
            ...
            if (result?.error?.issues !== undefined){
                console.log("productRequestSchema - should accept a valid product_price of minimum value (1) - product_price - result?.error?.issues ", result?.error?.issues);
            }
            
            else {
                console.log("productRequestSchema - should accept a valid product_price of minimum value (1) - product_price - result ", result);
            }
        ...
        const testData = {
            ...
            if (result?.error?.issues !== undefined){
                console.log("productRequestSchema - should accept a valid product_price of maximum value (300) - product_price - result?.error?.issues ", result?.error?.issues);
            }
            
            else {
                console.log("productRequestSchema - should accept a valid product_price of maximum value (300) - product_price - result ", result);
            }
