...
class RedundantUpdateError extends CustomError {
        constructor(message) {
        // Passes the message to CustomError
        super(message);
        // Sets the name of the error
        this.name = 'RedundantUpdateError';
        // Sets the statusCode for this instance of RedundantUpdateError
...
module.exports = RedundantUpdateError;