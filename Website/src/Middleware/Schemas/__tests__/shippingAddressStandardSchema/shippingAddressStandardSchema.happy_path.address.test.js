...
describe('shippingAddressStandardSchema - ADDRESS Tests', () => {
    test('shippingAddressStandardSchema - should accept address minimum length "7"', () => {
        ...
        if (result?.error?.issues !== undefined){
            console.log("shippingAddressStandardSchema - should accept address minimum length 7 - result?.error?.issues ", result?.error?.issues);
        }
        else {
            console.log("shippingAddressStandardSchema - should accept address minimum length 7 - result ", result);
        }
    ...
    test('shippingAddressStandardSchema - should accept address maximum length', () => {
        ...
        if (result?.error?.issues !== undefined){
            console.log("shippingAddressStandardSchema - should accept address maximum length - result?.error?.issues ", result?.error?.issues);
        }
        else {
            console.log("shippingAddressStandardSchema - should accept address maximum length - result ", result);
        }
