...
describe('userResponseGenericSchema - Upper Size Number Field Validation Tests', () => {
    test('userResponseGenericSchema - should accept valid upper_size_number (46)', () => {
        // Arrange
        const testData = {
    ...
    test('userResponseGenericSchema - should accept valid upper_size_number (44)', () => {
        // Arrange
        const testData = {
            user_id: "ab01dhiojniu",
            docType: "USER",
    ...
    test('userResponseGenericSchema - should accept valid upper_size_number (42)', () => {
        // Arrange
        const testData = {
            user_id: "ab01dhiojniu",
            docType: "USER",
    ...
    test('userResponseGenericSchema - should accept valid upper_size_number (40)', () => {
        // Arrange
        const testData = {
            user_id: "ab01dhiojniu",
            docType: "USER",
    ...
    test('userResponseGenericSchema - should accept valid upper_size_number (38)', () => {
        // Arrange
        const testData = {
            user_id: "ab01dhiojniu",
            docType: "USER",
    ...
    test('userResponseGenericSchema - should accept valid upper_size_number (36)', () => {
        // Arrange
        const testData = {
            user_id: "ab01dhiojniu",
            docType: "USER",
    ...
    test('userResponseGenericSchema - should reject invalid upper_size_number (48 - out of range)', () => {
        // Arrange
        const testData = {
            user_id: "ab01dhiojniu",
            docType: "USER",
    ...
    test('userResponseGenericSchema - should reject invalid upper_size_number (34 - out of range)', () => {
        // Arrange
        const testData = {
            user_id: "ab01dhiojniu",
            docType: "USER",
    ...
    test('userResponseGenericSchema - should reject invalid upper_size_number datatype (string)', () => {
        // Arrange
        const testData = {
            user_id: "ab01dhiojniu",
            docType: "USER",
    ...
    test('userResponseGenericSchema - should reject missing upper_size_number (null)', () => {
        // Arrange
        const testData = {
            user_id: "ab01dhiojniu",
            docType: "USER",
