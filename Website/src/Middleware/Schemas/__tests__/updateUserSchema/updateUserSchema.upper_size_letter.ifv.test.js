...
describe('updateUserSchema - Upper Size Letter Field Validation Tests', () => {
    test('updateUserSchema - should accept valid upper_size_letter (XXL)', () => {
        // Arrange
        const testData = {
    ...
    test('updateUserSchema - should accept valid upper_size_letter (XL)', () => {
        // Arrange
        const testData = {
            email: "abc_d01@hostmail.com",
            phone_number: "917560847544",
    ...
    test('updateUserSchema - should accept valid upper_size_letter (L)', () => {
        // Arrange
        const testData = {
            email: "abc_d01@hostmail.com",
            phone_number: "917560847544",
    ...
    test('updateUserSchema - should accept valid upper_size_letter (M)', () => {
        // Arrange
        const testData = {
            email: "abc_d01@hostmail.com",
            phone_number: "917560847544",
    ...
    test('updateUserSchema - should accept valid upper_size_letter (S)', () => {
        // Arrange
        const testData = {
            email: "abc_d01@hostmail.com",
            phone_number: "917560847544",
    ...
    test('updateUserSchema - should accept valid upper_size_letter (XS)', () => {
        // Arrange
        const testData = {
            email: "abc_d01@hostmail.com",
            phone_number: "917560847544",
    ...
    test('updateUserSchema - should reject invalid upper_size_letter (XXXL - not in enum)', () => {
        // Arrange
        const testData = {
            email: "abc_d01@hostmail.com",
            phone_number: "917560847544",
    ...
    test('updateUserSchema - should reject invalid upper_size_letter (XXS - not in enum)', () => {
        // Arrange
        const testData = {
            email: "abc_d01@hostmail.com",
            phone_number: "917560847544",
    ...
    test('updateUserSchema - should reject invalid upper_size_letter datatype (number)', () => {
        // Arrange
        const testData = {
            email: "abc_d01@hostmail.com",
            phone_number: "917560847544",
    ...
    test('updateUserSchema - should reject empty upper_size_letter', () => {
        // Arrange
        const testData = {
            email: "abc_d01@hostmail.com",
            phone_number: "917560847544",
    ...
    test('updateUserSchema - should reject missing upper_size_letter (null)', () => {
        // Arrange
        const testData = {
            email: "abc_d01@hostmail.com",
            phone_number: "917560847544",
