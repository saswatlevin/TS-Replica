...
describe('updateShippingAddressRequestSchema - Happy Path Tests', () => {
    test('updateShippingAddressRequestSchema - should accept valid shipping address data set 1', () => {
        // Arrange
        const testData = {
            address_type_id: "1",
        ...
        if (result?.error?.issues !== undefined){
            console.log("updateShippingAddressRequestSchema - should accept valid shipping address data set 1 - result?.error?.issues ", result?.error?.issues);
        }
        else {
            console.log("updateShippingAddressRequestSchema - should accept valid shipping address data set 1 - result ", result);
        }
    ...
    test('updateShippingAddressRequestSchema - should accept valid shipping address data set 2', () => {
        // Arrange
        const testData = {
            address_type_id: "1",
        ...
        if (result?.error?.issues !== undefined){
            console.log("updateShippingAddressRequestSchema - should accept valid shipping address data set 2 - result?.error?.issues ", result?.error?.issues);
        }
        else {
            console.log("updateShippingAddressRequestSchema - should accept valid shipping address data set 2 - result ", result);
        }
