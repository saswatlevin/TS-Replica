...
const zodIsTotalItemTotal = z.number({
    message: "The total_item_total field must be a number."
...
const zodIsTotalDiscountAmount = z.number({
    message: "The total_discount_amount field must be a number."
...
const zodIsTotalDiscountPercentage = z.number({
    message: "The total_discount_percentage field must be a number."
...
const zodIsTotalDiscountedTotal = z.number({
    message: "The total_discounted_total field must be a number."
...
const zodIsTotalPayableAmount = z.number({
    message: "The total_payable_amount field must be a number."
...
const zodIsMessage = z.string("The message field must be a string.").regex(messageRegex, {
    message: "The message field must contain only letters, numbers, dots and spaces."
}).min(1, { message: "The message field has a minimum length of 1 character." }).max(200, { message: "The message field has a maximum permitted length of 200 characters." });
