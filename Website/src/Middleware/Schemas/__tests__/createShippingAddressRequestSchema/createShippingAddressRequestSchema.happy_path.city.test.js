...
describe('createShippingAddressRequestSchema - CITY Boundary Tests', () => {
    test('createShippingAddressRequestSchema - should accept city minimum length "Rio"', () => {
        // Arrange
        const testData = {
            address_type_id: "1",
        ...
        if (result?.error?.issues !== undefined){
            console.log("createShippingAddressRequestSchema - should accept city minimum length Rio - result?.error?.issues ", result?.error?.issues);
        }
        else {
            console.log("createShippingAddressRequestSchema - should accept city minimum length Rio - result ", result);
        }
    ...
    test('createShippingAddressRequestSchema - should accept city maximum length', () => {
        // Arrange
        ...
        if (result?.error?.issues !== undefined){
            console.log("createShippingAddressRequestSchema - should accept city maximum length - result?.error?.issues ", result?.error?.issues);
        }
        else {
            console.log("createShippingAddressRequestSchema - should accept city maximum length - result ", result);
        }
