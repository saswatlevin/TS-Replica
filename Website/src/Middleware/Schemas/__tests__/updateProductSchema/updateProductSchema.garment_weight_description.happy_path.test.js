...
describe('updateProductSchema - HAPPY PATH TEST - garment_weight_description', () => {
    test('should accept a valid garment_weight_description of minimum length (1 character) - ', () => {
        ...
        if (result?.error?.issues !== undefined){
            console.log("updateProductSchema - should accept a valid garment_weight_description of minimum length (1 character) - garment_weight_description - result?.error?.issues ", result?.error?.issues);
        }
            
        else {
            console.log("updateProductSchema - should accept a valid garment_weight_description of minimum length (1 character) - garment_weight_description - result ", result);
        }
    ...
    test('should accept a valid garment_weight_description of maximum length (200 characters) - ', () => {
        ...
        if (result?.error?.issues !== undefined){
            console.log("updateProductSchema - should accept a valid garment_weight_description of maximum length (200 characters) - garment_weight_description - result?.error?.issues ", result?.error?.issues);
        }
            
        else {
            console.log("updateProductSchema - should accept a valid garment_weight_description of maximum length (200 characters) - garment_weight_description - result ", result);
        }
