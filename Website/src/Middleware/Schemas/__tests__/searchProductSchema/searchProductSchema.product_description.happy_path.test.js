...
describe('searchProductSchema - HAPPY PATH TEST - product_description', () => {
    test('should accept a valid product_description of minimum length (1 character)', () => {
        ...
        const testData = {
            ...
            if (result?.error?.issues !== undefined){
                console.log("searchProductSchema - should accept a valid product_description of minimum length (1 character) - product_description - result?.error?.issues ", result?.error?.issues);
            }
            
            else {
                console.log("searchProductSchema - should accept a valid product_description of minimum length (1 character) - product_description - result ", result);
            }
        ...
        const testData = {
            ...
            if (result?.error?.issues !== undefined){
                console.log("searchProductSchema - should accept a valid product_description of maximum length (700 characters) - product_description - result?.error?.issues ", result?.error?.issues);
            }
            
            else {
                console.log("searchProductSchema - should accept a valid product_description of maximum length (700 characters) - product_description - result ", result);
            }
