...
describe('productRequestSchema - HAPPY PATH TEST - supply_type_description', () => {
    test('should accept valid supply_type_description - TEST 1 ', () => {
        ...
        const testData = {
            ...
            if (result?.error?.issues !== undefined){
                console.log("productRequestSchema - should accept valid supply_type_description - TEST 1 - supply_type_description - result?.error?.issues ", result?.error?.issues);
            }
            
            else {
                console.log("productRequestSchema - should accept valid supply_type_description - TEST 1 - supply_type_description - result ", result);
            }
        ...
        const testData = {
            ...
            const result = productRequestSchema.safeParse(testData);
            if (result?.error?.issues !== undefined){
                console.log("productRequestSchema - should accept valid supply_type_description - TEST 2 - supply_type_description - result?.error?.issues ", result?.error?.issues);
            }
            
            else {
                console.log("productRequestSchema - should accept valid supply_type_description - TEST 2 - supply_type_description - result ", result);
            }
