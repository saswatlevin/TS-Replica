...
#print("TEST 1 - Update a Product (Name) ", update_product_name_response.text)
...
#print("TEST 2 - Update a Product (Color) ", update_product_color_response.text)
...
#print("TEST 3 - Update a Product (Description) ", update_product_description_response.text)
...
#print("TEST 4 - Update a Product (Category) ", update_product_category_response.text)
...
#print("TEST 5 - Update a Product (Subcategory) ", update_product_subcategory_response.text)
...
#print("TEST 6 - Update a Product (Subcategory Type) ", update_product_subcategory_type_response.text)
...
#print("TEST 7 - Update a Product (Fit) ", update_product_fit_response.text)
...
#print("TEST 8 - Update a Product (Specifications) ", update_product_specifications_response.text)
...
#print("TEST 9 - Update a Product (Material) ", update_product_material_response.text)
...
update_product_supply_type_url_1 = "http://localhost:3500/products/updateproductsupplytype/a6bb1d23bd28"
...
update_product_name_url_1 = "http://localhost:3500/products/updateproductname/d2a986a0cab3/a6bb1d23bd28"
