...
describe('productRequestSchema - HAPPY PATH TEST - product_name', () => {
    test('should accept a valid product_name of minimum length (3 characters)', () => {
        ...
        const testData = {
            ...
            if (result?.error?.issues !== undefined){
                console.log("productRequestSchema - should accept a valid product_name of minimum length (3 characters) - product_name - result?.error?.issues ", result?.error?.issues);
            }
            
            else {
                console.log("productRequestSchema - should accept a valid product_name of minimum length (3 characters) - product_name - result ", result);
            }
        ...
        const testData = {
            ...
            if (result?.error?.issues !== undefined){
                console.log("productRequestSchema - should accept a valid product_name of maximum length (50 characters) - product_name - result?.error?.issues ", result?.error?.issues);
            }
            
            else {
                console.log("productRequestSchema - should accept a valid product_name of maximum length (50 characters) - product_name - result ", result);
            }
