...
describe('userResponseGenericSchema - SMS Comms Field Validation Tests', () => {
    test('userResponseGenericSchema - should accept valid sms_comms (false)', () => {
        // Arrange
        const testData = {
    ...
    test('userResponseGenericSchema - should accept valid sms_comms (true)', () => {
        // Arrange
        const testData = {
            user_id: "ab01dhiojniu",
            docType: "USER",
    ...
    test('userResponseGenericSchema - should reject invalid sms_comms datatype (string)', () => {
        // Arrange
        const testData = {
            user_id: "ab01dhiojniu",
            docType: "USER",
    ...
    test('userResponseGenericSchema - should reject missing sms_comms (null)', () => {
        // Arrange
        const testData = {
            user_id: "ab01dhiojniu",
            docType: "USER",
