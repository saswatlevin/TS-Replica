...
describe('productResponseSchema - product_subcategory - HAPPY PATH TEST', () => {
    test('should accept a valid product_subcategory - TEST 1', () => {
        ...
        if (!result.success){
            console.log("productResponseSchema - should accept a valid product_subcategory - TEST 1 - product_subcategory - result?.error?.issues ", result?.error?.issues);
        }
        
        else {
            console.log("productResponseSchema - should accept a valid product_subcategory - TEST 1 - product_subcategory - result ", result);
        }
        ...
        if (!result.success){
            console.log("productResponseSchema - should accept a valid product_subcategory - TEST 2 - product_subcategory - result?.error?.issues ", result?.error?.issues);
        }
        
        else {
            console.log("productResponseSchema - should accept a valid product_subcategory - TEST 2 - product_subcategory - result ", result);
        }
