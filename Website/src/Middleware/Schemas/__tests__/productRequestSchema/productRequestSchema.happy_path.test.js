...
describe('productRequestSchema - HAPPY PATH Tests', () => {
    test('productRequestSchema - HAPPY PATH TEST Set 1', () => {
        // Arrange
  ...
  [
    ...
    if (result?.error?.issues !== undefined){
        console.log("productRequestSchema - HAPPY PATH TEST Set 1 - result?.error?.issues ", result?.error?.issues);
    }
    
    else {
        console.log("productRequestSchema - HAPPY PATH TEST Set 1 - result ", result);
    }
  ...
  product_items: [
    ...
    if (result?.error?.issues !== undefined){
        console.log("productRequestSchema - HAPPY PATH TEST Set 2 - result?.error?.issues ", result?.error?.issues);
    }
    
    else {
        console.log("productRequestSchema - HAPPY PATH TEST Set 2 - result ", result);
    }
