...
describe('createShippingAddressResponseSchema - ADMINISTRATIVE_DIVISION Boundary Tests', () => {
    test('createShippingAddressResponseSchema - should accept administrative_division minimum length ""', () => {
        // Arrange
        const testData = {
        ...
        if (result?.error?.issues !== undefined){
            console.log("createShippingAddressResponseSchema - should accept administrative_division minimum length - result?.error?.issues ", result?.error?.issues);
        }
        else {
            console.log("createShippingAddressResponseSchema - should accept administrative_division minimum length - result ", result);
        }
    ...
    test('createShippingAddressResponseSchema - should accept administrative_division maximum length', () => {
        // Arrange
        ...
        if (result?.error?.issues !== undefined){
            console.log("createShippingAddressResponseSchema - should accept administrative_division maximum length - result?.error?.issues ", result?.error?.issues);
        }
        else {
            console.log("createShippingAddressResponseSchema - should accept administrative_division maximum length - result ", result);
        }
