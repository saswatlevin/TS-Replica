...
describe('searchProductSchema - Test product_subcategory_type', () => {
    test('should accept a valid product_subcategory_type - TEST 1', () => {
        ...
        if (result?.error?.issues !== undefined){
            console.log("searchProductSchema - should accept a valid product_subcategory - TEST 2 - result?.error?.issues ", result?.error?.issues);
        }   

        else {
            console.log("searchProductSchema - should accept a valid product_subcategory - TEST 2 - result ", result);
        }
    ...
    test('should accept a valid product_subcategory_type - TEST 3', () => {
        ...
        if (result?.error?.issues !== undefined){
            console.log("searchProductSchema - should accept a valid product_subcategory - TEST 3 - result?.error?.issues ", result?.error?.issues);
        }   

        else {
            console.log("searchProductSchema - should accept a valid product_subcategory - TEST 3 - result ", result);
        }
    ...
    test('should accept a valid product_subcategory_type - TEST 4', () => {
        ...
        if (result?.error?.issues !== undefined){
            console.log("searchProductSchema - should accept a valid product_subcategory - TEST 5 - result?.error?.issues ", result?.error?.issues);
        }   

        else {
            console.log("searchProductSchema - should accept a valid product_subcategory - TEST 5 - result ", result);
        }
        ...
        if (result?.error?.issues !== undefined){
            console.log("searchProductSchema - should accept a valid product_subcategory - TEST 6 - result?.error?.issues ", result?.error?.issues);
        }   

        else {
            console.log("searchProductSchema - should accept a valid product_subcategory - TEST 6 - result ", result);
        }
    ...
    test('should accept a valid product_subcategory_type - TEST 7', () => {
        ...
        if (result?.error?.issues !== undefined){
            console.log("searchProductSchema - should accept a valid product_subcategory - TEST 7 - result?.error?.issues ", result?.error?.issues);
        }   

        else {
            console.log("searchProductSchema - should accept a valid product_subcategory - TEST 7 - result ", result);
        }
