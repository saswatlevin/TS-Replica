...
describe('updateProductSchema - HAPPY PATH TEST - product_specifications', () => {
    test('should accept valid product_specifications of minimum length (1 character)', () => {
        ...
        const testData = {
            ...
            if (result?.error?.issues !== undefined){
                console.log("updateProductSchema - should accept valid product_specifications of minimum length (1 character) - TEST 1 - product_specifications - result?.error?.issues ", result?.error?.issues);
            }
            
            else {
                console.log("updateProductSchema - should accept valid product_specifications of minimum length (1 character) - TEST 1 - product_specifications - result ", result);
            }
    ...
    test('should accept valid product_specifications of maximum length (500 characters)', () => {
        ...
        const testData = {
            ...
            if (result?.error?.issues !== undefined){
                console.log("updateProductSchema - should accept valid product_specifications of maximum length (500 characters) - TEST 2 - product_specifications - result?.error?.issues ", result?.error?.issues);
            }
            
            else {
                console.log("updateProductSchema - should accept valid product_specifications of maximum length (500 characters) - TEST 2 - product_specifications - result ", result);
            }
