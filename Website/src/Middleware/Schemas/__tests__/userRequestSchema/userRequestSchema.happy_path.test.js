...
describe('userRequestSchema - Happy Path Tests', () => {
    ...
    describe('Basic Happy Path Test Cases', () => {
       ...
       test('should accept complete valid user registration data with user role', () => {
            ...
            console.log("userRequestSchema - should accept complete valid user registration data with user role' - result?.error?.issues ",   result?.error?.issues);
    ...
    describe('Happy Path Boundary Test Cases', () => {
        test('should accept valid date boundary value (59:59 seconds)', () => {
            ...
            console.log("userRequestSchema - should accept valid date boundary value (59:59 seconds)' - result?.error?.issues ",   result?.error?.issues);
        ...
        test('should accept valid email with special characters', () => {
            ...
            console.log("userRequestSchema - should accept valid email with special characters' - result?.error?.issues ",   result?.error?.issues);
        ...
        test('should accept email at minimum length boundary (9 characters)', () => {
            ...
            console.log("userRequestSchema - should accept email at minimum length boundary (9 characters)' - result?.error?.issues ",   result?.error?.issues);
        ...
        test('should accept email at maximum length boundary (30 characters)', () => {
            ...
            console.log("userRequestSchema - should accept email at maximum length boundary (30 characters)' - result?.error?.issues ",   result?.error?.issues);
        ...
        test('should accept phone number at minimum length boundary (8 digits)', () => {
            ...
            console.log("userRequestSchema - should accept phone number at minimum length boundary (8 digits)' - result?.error?.issues ",   result?.error?.issues);
        ...
        test('should accept phone number at maximum length boundary (12 digits)', () => {
            ...
            console.log("userRequestSchema - should accept phone number at maximum length boundary (12 digits)' - result?.error?.issues ",   result?.error?.issues);
        ...
        test('should accept first name with special characters (apostrophe)', () => {
            ...
            console.log("userRequestSchema - should accept first name with special characters (apostrophe)' - result?.error?.issues ",   result?.error?.issues);
        ...
        test('should accept first name at minimum length boundary (1 character)', () => {
            ...
            console.log("userRequestSchema - should accept first name at minimum length boundary (1 character)' - result?.error?.issues ",   result?.error?.issues);
        ...
        test('should accept first name at maximum length boundary (100 characters)', () => {
            ...
            console.log("userRequestSchema - should accept first name at maximum length boundary (100 characters)' - result?.error?.issues ",   result?.error?.issues);
        ...
        test('should accept last name with special characters (hyphen)', () => {
            ...
            console.log("userRequestSchema - should accept last name with special characters (hyphen)' - result?.error?.issues ",   result?.error?.issues);
        ...
        test('should accept last name at minimum length boundary (1 character)', () => {
            ...
            console.log("userRequestSchema - should accept last name at minimum length boundary (1 character)' - result?.error?.issues ",   result?.error?.issues);
        ...
        test('should accept last name at maximum length boundary (100 characters)', () => {
            ...
            console.log("userRequestSchema - should accept last name at maximum length boundary (100 characters)' - result?.error?.issues ",   result?.error?.issues);
