...
const the_apres_short_navy_linen_tweed_response_schema = {
  "_id": new mongoose.Types.ObjectId("6832525c815f56fea947db78"),
  ...
  "discount_amount": 18.8,
  "discounted_total": 75.2,
  "__v": 0
};

const the_breakwater_pant_in_rinsed_indigo_stripe_response_schema = {
  "_id": new mongoose.Types.ObjectId("6a16d12e4a807bc87031dfae"),
  ...
  "discounted_total": 115.2,
  "__v": 0
};

const the_camp_short_in_aged_penny_chipped_canvas_response_schema = {
  "_id": new mongoose.Types.ObjectId("6a12de36a55316e77742d484"),
  ...
  "discount_amount": 29.4,
  "discounted_total": 68.6,
  "__v": 0
};

const the_craftsman_shirt_in_bark_plaid_cotton_response_schema = {
  "_id": new mongoose.Types.ObjectId("6932ae73278b1c0176a50a7c"),
  ...
  "discount_amount": 45,
  "discounted_total": 255,
  "__v": 0
};

const the_painter_pant_in_seeded_natural_chipped_canvas_response_schema = {
  "_id": new mongoose.Types.ObjectId("6832524b815f56fea947db77"),
  ...
  "discount_code": "10PERCENT",
  "discount_percentage": 10,
  "discount_amount": 13.8,
  "discounted_total": 124.2,
  "__v": 0
};

module.exports = {
	the_apres_short_navy_linen_tweed_response_schema,
	the_breakwater_pant_in_rinsed_indigo_stripe_response_schema,
	the_camp_short_in_aged_penny_chipped_canvas_response_schema,
	the_craftsman_shirt_in_bark_plaid_cotton_response_schema,
	the_painter_pant_in_seeded_natural_chipped_canvas_response_schema
};