...
const { userRequestSchema } = require('../../userSchemas');
    ...
    describe('userRequestSchema - Others Size Letter Field Validation Tests', () => {
        test('userRequestSchema - should accept valid others_size_letter (XXL)', () => {
            // Arrange
            const testData = {
        ...
        test('userRequestSchema - should accept valid others_size_letter (XL)', () => {
            // Arrange
            const testData = {
                email: "abc_d01@hostmail.com",
                password: "Soyuz@1966#USSR",
        ...
        test('userRequestSchema - should accept valid others_size_letter (L)', () => {
            // Arrange
            const testData = {
                email: "abc_d01@hostmail.com",
                password: "Soyuz@1966#USSR",
        ...
        test('userRequestSchema - should accept valid others_size_letter (M)', () => {
            // Arrange
            const testData = {
                email: "abc_d01@hostmail.com",
                password: "Soyuz@1966#USSR",
        ...
        test('userRequestSchema - should accept valid others_size_letter (S)', () => {
            // Arrange
            const testData = {
                email: "abc_d01@hostmail.com",
                password: "Soyuz@1966#USSR",
        ...
        test('userRequestSchema - should accept valid others_size_letter (XS)', () => {
            // Arrange
            const testData = {
                email: "abc_d01@hostmail.com",
                password: "Soyuz@1966#USSR",
        ...
        test('userRequestSchema - should reject invalid others_size_letter (XXXL - not in enum)', () => {
            // Arrange
            const testData = {
                email: "abc_d01@hostmail.com",
                password: "Soyuz@1966#USSR",
        ...
        test('userRequestSchema - should reject invalid others_size_letter (XXS - not in enum)', () => {
            // Arrange
            const testData = {
                email: "abc_d01@hostmail.com",
                password: "Soyuz@1966#USSR",
        ...
        test('userRequestSchema - should reject invalid others_size_letter datatype (number)', () => {
            // Arrange
            const testData = {
                email: "abc_d01@hostmail.com",
                password: "Soyuz@1966#USSR",
        ...
        test('userRequestSchema - should reject empty others_size_letter', () => {
            // Arrange
            const testData = {
                email: "abc_d01@hostmail.com",
                password: "Soyuz@1966#USSR",
        ...
        test('userRequestSchema - should reject missing others_size_letter (null)', () => {
            // Arrange
            const testData = {
                email: "abc_d01@hostmail.com",
                password: "Soyuz@1966#USSR",
