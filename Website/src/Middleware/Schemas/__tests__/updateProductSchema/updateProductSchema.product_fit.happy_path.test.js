...
describe('updateProductSchema - HAPPY PATH TEST - product_fit', () => {
    test('should accept a valid product_fit of minimum length (1 character)', () => {
      ...
      const testData = {
        ...
        if (result?.error?.issues !== undefined){
          console.log("updateProductSchema - should accept a valid product_fit of minimum length (1 character) - product_fit - result?.error?.issues ", result?.error?.issues);
        }
            
        else {
          console.log("updateProductSchema - should accept a valid product_fit of minimum length (1 character) - product_fit - result ", result);
        }
      ...
      const testData = {
        ...
        if (result?.error?.issues !== undefined){
          console.log("updateProductSchema - should accept a valid product_fit of minimum length (400 characters) - product_fit - result?.error?.issues ", result?.error?.issues);
        }
            
        else {
          console.log("updateProductSchema - should accept a valid product_fit of minimum length (400 characters) - product_fit - result ", result);
        }
