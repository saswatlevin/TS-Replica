...
describe('userResponseGenericSchema - Email Comms Type Field Validation Tests', () => {
    test('userResponseGenericSchema - should accept valid email_comms_type ("I want all emails")', () => {
        // Arrange
        const testData = {
    ...
    test('userResponseGenericSchema - should accept valid email_comms_type ("One weekly recap")', () => {
        // Arrange
        const testData = {
            user_id: "ab01dhiojniu",
            docType: "USER",
    ...
    test('userResponseGenericSchema - should accept valid email_comms_type ("Stock notifications only")', () => {
        // Arrange
        const testData = {
            user_id: "ab01dhiojniu",
            docType: "USER",
    ...
    test('userResponseGenericSchema - should accept valid email_comms_type ("Never / Unsubscribe")', () => {
        // Arrange
        const testData = {
            user_id: "ab01dhiojniu",
            docType: "USER",
    ...
    test('userResponseGenericSchema - should reject invalid email_comms_type ("Always" - not in enum)', () => {
        // Arrange
        const testData = {
            user_id: "ab01dhiojniu",
            docType: "USER",
    ...
    test('userResponseGenericSchema - should reject invalid email_comms_type datatype (number)', () => {
        // Arrange
        const testData = {
            user_id: "ab01dhiojniu",
            docType: "USER",
    ...
    test('userResponseGenericSchema - should reject empty email_comms_type', () => {
        // Arrange
        const testData = {
            user_id: "ab01dhiojniu",
            docType: "USER",
    ...
    test('userResponseGenericSchema - should reject missing email_comms_type (null)', () => {
        // Arrange
        const testData = {
            user_id: "ab01dhiojniu",
            docType: "USER",
