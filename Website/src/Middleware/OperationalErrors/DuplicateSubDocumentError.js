...
class DuplicateSubDocumentError extends CustomError {
        constructor(message) {
        // Passes the message to CustomError
        super(message);
        // Sets the name of the error
        this.name = 'DuplicateSubDocumentError';
        // Sets the statusCode for this instance of DuplicateSubDocumentError
...
module.exports = DuplicateSubDocumentError;