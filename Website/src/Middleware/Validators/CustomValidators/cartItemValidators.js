...
const zodIsCartItemPrice = z.number("The cart_item_price field must be a number(integer). It is a required field.").int("The cart_item_price field must be an integer.").min(1, {message: "The minimum limit of the cart_item_price field is 1."}).max(300, {message: "The maximum limit of the cart_item_price field is 300."});
