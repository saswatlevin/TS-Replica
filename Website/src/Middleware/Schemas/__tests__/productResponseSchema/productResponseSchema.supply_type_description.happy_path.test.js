...
describe('productResponseSchema - HAPPY PATH TEST - supply_type_description', () => {
    test('should accept valid supply_type_description - TEST 1 ', () => {
        // Arrange
        const testData = {
            ...
            if (result?.error?.issues !== undefined){
                console.log("productResponseSchema - should accept valid supply_type_description - TEST 1 - supply_type_description - result?.error?.issues ", result?.error?.issues);
            }
            
            else {
                console.log("productResponseSchema - should accept valid supply_type_description - TEST 1 - supply_type_description - result ", result);
            }
        ...
        test('should accept valid supply_type_description - TEST 2 ', () => {
        // Arrange
        const testData = {
            ...
            const result = productResponseSchema.safeParse(testData);
            if (result?.error?.issues !== undefined){
                console.log("productResponseSchema - should accept valid supply_type_description - TEST 2 - supply_type_description - result?.error?.issues ", result?.error?.issues);
            }
            
            else {
                console.log("productResponseSchema - should accept valid supply_type_description - TEST 2 - supply_type_description - result ", result);
            }
