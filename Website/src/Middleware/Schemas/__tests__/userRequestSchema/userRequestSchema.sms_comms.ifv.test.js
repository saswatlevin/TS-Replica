...
describe('userRequestSchema - SMS Comms Field Validation Tests', () => {
    test('userRequestSchema - should accept valid sms_comms (false)', () => {
        // Arrange
        const testData = {
    ...
    test('userRequestSchema - should accept valid sms_comms (true)', () => {
        // Arrange
        const testData = {
            email: "abc_d01@hostmail.com",
            password: "Soyuz@1966#USSR",
    ...
    test('userRequestSchema - should reject invalid sms_comms datatype (string)', () => {
        // Arrange
        const testData = {
            email: "abc_d01@hostmail.com",
            password: "Soyuz@1966#USSR",
    ...
    test('userRequestSchema - should reject missing sms_comms (null)', () => {
        // Arrange
        const testData = {
            email: "abc_d01@hostmail.com",
            password: "Soyuz@1966#USSR",
