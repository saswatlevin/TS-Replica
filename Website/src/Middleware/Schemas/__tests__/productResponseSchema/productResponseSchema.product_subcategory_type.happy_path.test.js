...
describe('productResponseSchema - Test product_subcategory_type', () => {
    test('should accept a valid product_subcategory_type - TEST 1', () => {
        ...
        if (result?.error?.issues !== undefined){
            console.log("productResponseSchema - should accept a valid product_subcategory - TEST 2 - result?.error?.issues ", result?.error?.issues);
        }   

        else {
            console.log("productResponseSchema - should accept a valid product_subcategory - TEST 2 - result ", result);
        }

        // Assert
        expect(result.success).toBe(true);
        expect(typeof result.data.product_subcategory_type).toBe('string');
        ...
        expect(result.success).toBe(true);
        expect(typeof result.data.product_subcategory_type).toBe('string');
        expect(result.data.product_subcategory_type).toBe("Short-Sleeved Shirt");
    ...
    test('should accept a valid product_subcategory_type - TEST 3', () => {
        ...
        if (result?.error?.issues !== undefined){
            console.log("productResponseSchema - should accept a valid product_subcategory - TEST 3 - result?.error?.issues ", result?.error?.issues);
        }   

        else {
            console.log("productResponseSchema - should accept a valid product_subcategory - TEST 3 - result ", result);
        }

        // Assert
        expect(result.success).toBe(true);
        expect(typeof result.data.product_subcategory_type).toBe('string');
        expect(result.data.product_subcategory_type).toBe("Oxford");
    ...
    test('should accept a valid product_subcategory_type - TEST 4', () => {
        ...
        if (result?.error?.issues !== undefined){
            console.log("productResponseSchema - should accept a valid product_subcategory - TEST 5 - result?.error?.issues ", result?.error?.issues);
        }   

        else {
            console.log("productResponseSchema - should accept a valid product_subcategory - TEST 5 - result ", result);
        }

        // Assert
        expect(result.success).toBe(true);
        expect(typeof result.data.product_subcategory_type).toBe('string');
        expect(result.data.product_subcategory_type).toBe("Jean");
        ...
        if (result?.error?.issues !== undefined){
            console.log("productResponseSchema - should accept a valid product_subcategory - TEST 6 - result?.error?.issues ", result?.error?.issues);
        }   

        else {
            console.log("productResponseSchema - should accept a valid product_subcategory - TEST 6 - result ", result);
        }

        // Assert
        expect(result.success).toBe(true);
        expect(typeof result.data.product_subcategory_type).toBe('string');
        expect(result.data.product_subcategory_type).toBe("Pant");
    ...
    test('should accept a valid product_subcategory_type - TEST 7', () => {
        ...
        if (result?.error?.issues !== undefined){
            console.log("productResponseSchema - should accept a valid product_subcategory - TEST 7 - result?.error?.issues ", result?.error?.issues);
        }   

        else {
            console.log("productResponseSchema - should accept a valid product_subcategory - TEST 7 - result ", result);
        }

        // Assert
        expect(result.success).toBe(true);
        expect(typeof result.data.product_subcategory_type).toBe('string');
        expect(result.data.product_subcategory_type).toBe("Short");
